...
| GemFire | [`release`](http://dist.gemstone.com.s3.amazonaws.com/maven/release/com/gemstone/gemfire/gemfire/8.2.0/gemfire-8.2.0.pom)
...
| JRE Version | Build Number | Tag           | OS X | Trusty |
| ----------- | ------------ | ------------- | :--: | :----: |
| `1.8.0_77`  | `b03`        | `jdk8u77-b03  |      | ✓      |
| `1.8.0_73`  | `b02`        | `jdk8u73-b02` | ✓    | ✓      |
...
| NodeJS Version | Tag        | OS X | Trusty |
| -------------- | ---------- | :--: | :----: |
| `5.10.0`       | `v5.10.0 ` |      | ✓      |
| `5.9.1`        | `v5.9.1 `  |      | ✓      |
| `5.6.0`        | `v5.6.0 `  |      | ✓      |
...
| `5.0.0`        | `v5.0.0 `  |      | ✓      |
|                |            |      |        |
| `4.3.0`        | `v4.3.0 `  |      |        | LTS - Argon
| `4.2.6`        | `v4.2.6 `  |      |        | LTS - Argon
| `4.2.5`        | `v4.2.5 `  |      |        | LTS - Argon
| `4.2.4`        | `v4.2.4 `  |      |        | LTS - Argon
| `4.2.3`        | `v4.2.3 `  |      |        | LTS - Argon
| `4.2.2`        | `v4.2.2 `  |      |        | LTS - Argon
| `4.2.1`        | `v4.2.1 `  | ✓    | ✓      | LTS - Argon
| `4.2.0`        | `v4.2.0 `  |      |        |
| `4.1.2`        | `v4.1.2 `  |      |        |
| `4.1.1`        | `v4.1.1 `  | ✓    | ✓      |
| `4.1.0`        | `v4.1.0 `  | ✓    | ✓      |
