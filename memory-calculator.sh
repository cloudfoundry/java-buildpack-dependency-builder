...
INDEX_PATH_BIONIC="/memory-calculator/bionic/x86_64/index.yml"
...
UPLOAD_PATH_BIONIC="/memory-calculator/bionic/x86_64/memory-calculator-$VERSION.tar.gz"
...
transfer_to_s3 "memory-calculator-archives/java-buildpack-memory-calculator-*-linux.tar.gz" $UPLOAD_PATH_BIONIC
