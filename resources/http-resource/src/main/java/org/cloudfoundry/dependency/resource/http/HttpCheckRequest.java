...
final class HttpCheckRequest extends CheckRequest<HttpSource> {

    public HttpCheckRequest(@JsonProperty("source") HttpSource source, @JsonProperty("version") Optional<VersionReference> version) {
