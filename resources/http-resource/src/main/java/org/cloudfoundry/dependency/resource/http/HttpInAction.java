...
@Component
@Profile("in")
final class HttpInAction extends InAction {

    private final HttpClient httpClient;

    private final HttpInRequest request;

    HttpInAction(Path destination, HttpInRequest request, OutputUtils outputUtils, HttpClient httpClient) {
