...
@Component
@Profile("in")
final class JProfilerInAction extends InAction {

    private final HttpClient httpClient;

    private final JProfilerInRequest request;

    public JProfilerInAction(Path destination, JProfilerInRequest request, OutputUtils outputUtils, HttpClient httpClient) {
    ...
    private String getArtifactUri() {
        ...
        return String.format("https://download-keycdn.ej-technologies.com/jprofiler/jprofiler_linux_%d_%d_%d.tar.gz", version.getMajor(), version.getMinor(), version.getMicro());
    }
