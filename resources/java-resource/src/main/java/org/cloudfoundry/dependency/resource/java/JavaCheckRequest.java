...
final class JavaCheckRequest extends CheckRequest<JavaSource> {

    JavaCheckRequest(@JsonProperty("source") JavaSource source, @JsonProperty("version") Optional<VersionReference> version) {
