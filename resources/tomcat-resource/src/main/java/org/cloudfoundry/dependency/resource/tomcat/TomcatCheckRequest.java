...
final class TomcatCheckRequest extends CheckRequest<TomcatSource> {

    public TomcatCheckRequest(@JsonProperty("source") TomcatSource source, @JsonProperty("version") Optional<VersionReference> version) {
