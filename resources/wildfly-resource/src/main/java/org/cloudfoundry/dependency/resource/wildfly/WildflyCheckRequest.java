...
final class WildflyCheckRequest extends CheckRequest<WildflySource> {

    WildflyCheckRequest(@JsonProperty("source") WildflySource source, @JsonProperty("version") Optional<VersionReference> version) {
