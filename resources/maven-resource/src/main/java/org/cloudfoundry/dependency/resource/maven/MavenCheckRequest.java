...
final class MavenCheckRequest extends CheckRequest<MavenSource> {

    MavenCheckRequest(@JsonProperty("source") MavenSource source, @JsonProperty("version") Optional<VersionReference> version) {
