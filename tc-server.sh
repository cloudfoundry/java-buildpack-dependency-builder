...
accept_eula() {
  ...
  wget -O- --post-data="" --header="Authorization: Token ${PIVNET_API_KEY}" https://network.pivotal.io/api/v2/products/pivotal-tcserver/releases/${RELEASE_ID}/eula_acceptance
}
